...
print("Exelon StringSession oluşturucu")

print("t ==> Telethon (docs.telethon.dev)")
print("Telethon UserBot ==> https://GitHub.com/BristolMyers/ExelonUserBot")
...
with TelegramClient(
    ...
    s_m.reply("⬆️ Bu StringSession, https://exelonstringalici.bristolmyers.repl.run/ kullanılarak oluşturuldu! ")
